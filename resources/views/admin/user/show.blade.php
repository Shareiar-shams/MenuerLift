    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-success offset-md-5" href="{{ route('user.create') }}">Add new</a>
                  ...
                  @foreach($users as $user)
                    <tr>
                      ...
                      <td>
                        ...
                        <a onclick="if(confirm('Are you sure to delete this tag?')){event.preventDefault(); document.getElementById('delete-form-{{ $user->id }}').submit();}else{
