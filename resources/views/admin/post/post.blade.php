                ...
                <div class="row">
                 ...
                 <div class="container">
                   <div class="row">
                     ...
                     <div class="col-md-4">
                       <div class="pull-left">
                          <input type="checkbox" class="form-check-input" id="exampleCheck1" name="status" value="1"> Publish
                          
                        </div>
                     </div>
                     <div class="col-md-8">
                       <div class="pull-right">
                          Upload Image<input type="file" class="form-control" id="image" placeholder="Insert Photo" name="image">
                        </div>
                     </div>
